...
export function EditCollectionForm({ collection }: { collection: any }) {
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Modifique o nome da tabela ou ajuste seus campos de dados.</p>
        </div>
      </div>
