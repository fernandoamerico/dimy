...
import { FileText, Plus, Package, Folder, Search, Trash2, LayoutGrid, List, Copy, Eye } from 'lucide-react';
        ...
        {categories.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-center p-12 bg-white/50 dark:bg-neutral-900/50 rounded-3xl border border-dashed border-gray-200 dark:border-neutral-800">
            ...
            <p className="text-gray-500 dark:text-gray-400 max-w-md mb-8">
              Você ainda não possui nenhuma categoria de produtos cadastrada.
            </p>
            {canManageContent && (
              <button
                onClick={() => setIsModalOpen(true)}
                      ...
                      <td className="px-6 py-4 text-right">
                        {canManageContent ? (
                          ...
                          <div className="flex items-center justify-end">
                            <Link
                              href={`/produtos/lista?slug=${cat.slug}`}
