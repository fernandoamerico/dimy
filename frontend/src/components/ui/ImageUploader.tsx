        ...
        <div className="space-y-2">
          ...
          {!canManageContent && (
            <input
              ...
              value={value}
              readOnly
              className="w-full px-3 py-1.5 bg-gray-50 dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg text-xs font-mono text-gray-700 dark:text-gray-300 focus:outline-none"
              title="URL da Imagem (Somente Leitura)"
            />
          )}
        </div>
      ) : !canManageContent ? (
        <div className="w-full py-6 rounded-xl border border-dashed border-gray-200 dark:border-neutral-800 bg-gray-50/50 dark:bg-neutral-950/50 flex flex-col items-center justify-center text-gray-400 text-xs italic">
